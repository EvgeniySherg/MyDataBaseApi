...
func (p *pg) DeleteBookById(ctx context.Context, id int) error {
	return nil
}
func (p *pg) UpdateBookById(ctx context.Context, book *models.Book) error {
	return nil
}
func (p *pg) CreateBook(ctx context.Context, b *models.Book) error {
	return nil
}
